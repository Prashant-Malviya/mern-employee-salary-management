...
} from '../../action/dataDeductionAction/dataDeductionActionTypes';
...
const dataDeductionReducer = (state = initialState, action) => {
    switch (action.type) {
        case GET_DATA_POTONGAN_SUCCESS:
            return {
                ...state,
                dataDeduction: action.payload,
                message: null,
                error: null,
            };
...
export default dataDeductionReducer;
