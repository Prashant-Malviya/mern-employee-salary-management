...
import { fetchReportAttendanceByMonth, fetchReportAttendanceByYear, getMe } from '../../../../config/redux/action';
...
const ReportAttendance = () => {
    ...
    const handleSearch = async (event) => {
        ...
        await Promise.all([
            dispatch(fetchReportAttendanceByYear(selectedYear, () => (yearDataFound = true))),
            dispatch(fetchReportAttendanceByMonth(selectedMonth, () => (monthDataFound = true))),
        ]);
        setShowMessage(true);
        ...
        if (yearDataFound && monthDataFound) {
            ...
            navigate(
                `/report/attendance/print-page?month=${selectedMonth}&year=${selectedYear}`
            );
        } else {
            setShowMessage(false);
            Swal.fire({
    ...
    return (
        <Layout>
            <Breadcrumb pageName='Report Attendance Employee' />
                    ...
                    <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
                        <div className='border-b border-stroke py-4 px-6.5 dark:border-strokedark'>
                            <h3 className='font-medium text-black dark:text-white'>
                                Filter Report Attendance Employee
                            </h3>
                        </div>
                            ...
                            <div className='p-6.5'>
                                ...
                                <div className='flex flex-col md:flex-row w-full gap-3 text-center'>
                                    <ButtonOne type='submit'>
                                        <span>Print Report Attendance</span>
                                        <span>
                                            <TfiPrinter />
                                        </span>
                                    </ButtonOne>
