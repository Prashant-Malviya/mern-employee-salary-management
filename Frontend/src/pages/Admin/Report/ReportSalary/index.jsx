...
import { getMe, fetchReportSalaryByMonth, fetchReportSalaryByYear } from '../../../../config/redux/action';
...
const ReportSalary = () => {
    ...
    return (
        <Layout>
            <Breadcrumb pageName='Report Salary Employee' />
