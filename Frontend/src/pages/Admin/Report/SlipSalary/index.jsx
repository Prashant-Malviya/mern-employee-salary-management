...
const SlipSalary = () => {
    ...
    const handleSearch = async (event) => {
        ...
        if (yearDataFound && monthDataFound && nameDataFound) {
            ...
            navigate(
                `/report/slip-salary/print-page?month=${selectedMonth}&year=${selectedYear}&name=${selectedName}`
            );
        } else {
            setShowMessage(false);
            Swal.fire({
    ...
    const nameOptions = dataEmployee.map((employee) => (
    ...
    return (
        <Layout>
            <Breadcrumb pageName='Slip Salary Employee' />
